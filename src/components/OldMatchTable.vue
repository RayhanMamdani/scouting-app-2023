<template>
    <div class="container">
        <div class="box my-4 has-background-dark">
            ...
            <div class="columns">
                <input type="text" class="input column is-one-quarter mr-5 has-background-light" name="teamFilter" id="teamFilter" placeholder="Filter by team number" @input="filterMatches();">
                <input type="text" class="input column is-one-quarter mr-5 has-background-light" name="matchFilter" id="matchFilter" placeholder="Filter by match number" @input="filterMatches();">
            </div>
            <div class="">
                <div class="table-container">
                    <label class="label has-text-white">Columns are sortable!</label>
                    <table class="table is-bordered is-fullwidth has-background-grey has-text-white">
                        <thead>
                            <tr>
